    ...
    <div class="modal-dialog" style="width: 1100px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="editModalLabel">功能点授权</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" id="hidCode">
                <div class="row">
                    <div id="tree" class="treeview col-sm-3"></div>
                    <div class=" col-sm-5">
                        <table>
                            <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class=" col-sm-10">
                        <select id='userSelected' multiple='multiple'></select>
                    </div>
                    <div class=" col-sm-1">
                    </div>
                </div>
...
<div class="modal fade" id="grantDetailsModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="editModalLabel">功能点权限详细</h4>
            </div>
            <input type="hidden" id="hidCode">
            <div class="modal-body">
                <table id="tbAccessDetails" class="table table-bordered table-hover dataTable">
                    <thead>
                    <tr>
                        <th aria-sort="none" aria-label="" width="60px">
                            <input type="checkbox" id="AllChange" onclick="SelectAll(this)"/>全选
...
<script src="../staticResource/js/accessManage/grantManage.js"></script>
</body>
</html>