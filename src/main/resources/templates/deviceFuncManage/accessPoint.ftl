        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-tag"></i>功能点授权列表</h3>
                </div>
                <div class="box-body">
                    <table id="accessPointList" class="table table-bordered table-hover dataTable"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">组织信息管理</h4>
                        </div>
                        <div class="modal-body">
                            <table class="table table-bordered"
                                   style="overflow: visible;">
                                <tr>
                                    <td class="col-sm-2">组织编码</td>
                                    <td class="col-sm-3">
                                        <div class="input-group"><input type="text" class="form-control"
                                                                        id="accessGroupCode"></div>
                                    </td>
                                    <td class="col-sm-2">客户编码</td>
                                    <td class="col-sm-3">
                                        <div class="input-group"><input type="text" class="form-control"
                                                                        id="clientCode"></div>
                                    </td>
                                ...
                                <tr>
                                    <td class="col-sm-2">设备编码</td>
                                    <td class="col-sm-3">
                                        <div class="input-group"><input type="text" class="form-control"
                                                                        id="deviceCode"></div>
                                    </td>
                                    <td class="col-sm-2">功能点编码</td>
                                    <td class="col-sm-3">
                                        <div class="input-group"><input type="text" class="form-control" id="FuncCode">
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<script src="../staticResource/js/accessManage/accessPoint.js"></script>
</body>
</html>