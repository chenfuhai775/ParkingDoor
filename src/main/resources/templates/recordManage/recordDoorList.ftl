...
<div class="wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-tag"></i>刷卡记录</h3>
                </div>
                <div class="box-body">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="#">美安科技</a>.</strong> All rights reserved.
    </footer>
...
<script src="../staticResource/js/recordManage/recordDoorList.js"></script>
</body>
</html>