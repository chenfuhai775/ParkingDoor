        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-tag"></i> 认证信息</h3>
                </div>
                <div class="box-body">
                ...
                <div class="modal-dialog" style="width: 800px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table" id="tbModal">
                                <tr>
                                    <td class="text-right"><label>设备名称</label></td>
                                    <td><input type="text" class="form-control" id="txtDeviceName"></td>
                                    <td class="text-right"><label>设备编码</label></td>
                                    <td><input type="text" class="form-control" id="txtDeviceCode"></td>
                                </tr>

                                <tr>
                                    <td class="text-right"><label>IP地址</label></td>
                                    <td><input type="text" class="form-control" id="txtIPAddress"></td>
                                    <td class="text-right"><label>端口号</label></td>
                                    <td><input type="text" class="form-control" id="txtDevicePort"></td>
                                </tr>
                                <tr>
...
<script src="../staticResource/js/attachManage/keyAttach.js"></script>
</body>
</html>