        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-tag"></i> 设备列表</h3>
                </div>
                <div class="box-body">
                    <table id="tbGrid" class="table table-bordered table-hover">
                        <thead>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered" id="tbModal">
                                <tr>
                                    <td class="text-right"><label>父节点</label></td>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td class="text-right"><label>设备名称</label></td>
                                    <td><input type="text" class="form-control" id="txtDeviceName"></td>
                                    <td class="text-right"><label>设备类型</label></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-right"><label>设备主题</label></td>
                                    <td><input type="text" class="form-control" id="txtdeviceTopic"></td>
                                    <td class="text-right"><label>SN</label></td>
                                    <td><input type="text" class="form-control" id="txtSn" data-bv-field="sn"></td>
                                </tr>
                                <tr>
                                    <td class="text-right"><label>IP地址</label></td>
                                    <td>
                                        <input type="text" id="txtIPAddress" class="form-control"
                                               data-inputmask="'alias': 'ip'" data-mask="">
                                    </td>
                                    <td class="text-right"><label>端口号</label></td>
                                    <td><input type="number" oninput="if(value.length>7)value=value.slice(0,7)"
                                               class="form-control" id="txtDevicePort"></td>
                                </tr>
                            </table>

                        </div>
                        <div class="modal-footer">
                            <button id="btndevSave" type="submit" class="btn btn-default glyphicon glyphicon-save">
                                &nbsp;保存
                            </button>
                            &nbsp;
...
<script src="../staticResource/js/deviceManage/deviceInfo.js"></script>
</body>
</html>