                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal bv-form" id="function-form" novalidate="novalidate">
                                <input type="hidden" id="guid" name="guid" value="" readonly="readonly">
                                <input type="hidden" name="parentid" value="" readonly="readonly">
...
<script src="../staticResource/js/baseManage/baseDatadict.js"></script>
</body>
</html>