...
<head>
    ...
    <script src="staticResource/adminlte/plugins/echarts/js/echarts.min.js"></script>
...
<div class="wrapper">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a id="existSytem" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="user/userRegister" class="small-box-footer">更多 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="device/list" class="small-box-footer">更多 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <a href="attach/list" class="small-box-footer">更多 <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- 每天认证统计 -->
            <div class="row">
                ...
                <section class="col-lg-7 connectedSortable ui-sortable">
                    ...
                    <div class="box box-solid">
                        <div class="box-body" style="position: relative; overflow: hidden; width: auto; height:300px;">
                            <div id="attach" style="height:300px;"></div>
                        </div>
                    </div>
                </section>
                <section class="col-lg-5 connectedSortable ui-sortable">
                    ...
                    <div class="box box-solid ">
                        <div class="box-body" style="position: relative; overflow: hidden; width: auto; height:300px;">
                            <div id="cpumain" style="height:300px;"></div>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <div class="row">
                ...
                <section class="col-lg-5 connectedSortable ui-sortable">
                    ...
                    <div class="box box-solid ">
                        <div class="box-body" style="position: relative; overflow: hidden; width: auto; height:300px;">
                            <div id="memoryMain" style="height:300px;"></div>
                        </div>
                    </div>
                </section>
            </div>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018 <a href="#">美安科技</a>.</strong> 版权所有
        </div>
    </footer>
...
<script src="staticResource/js/index.js"></script>
</body>
</html>